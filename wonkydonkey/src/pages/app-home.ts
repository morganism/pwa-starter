        ...
        <div id="welcomeBar">
          ...
          <sl-card id="infoCard">
            ...
            <div slot="buttons">
              <table>
                <tr>
                  <td> <sl-button href="${resolveRouterPath('about')}" variant="primary">About</sl-button></td>
                  <td><sl-button href="${resolveRouterPath('settings')}" variant="primary">Settings</sl-button></td>
                </tr>
              </table
            </div>
